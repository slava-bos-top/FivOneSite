...
const TelegramLogin = () => {
  ...
  const checkIfPhoneExists = async () => {
    const res = await fetch(`https://script.google.com/macros/s/AKfycbydkMOhNzyIhhZzGYBdRFQCn48hx27gMkWkqJf7eWuT_ILj6NKWP8MdXWozhk1BOGA/exec?phone=${phone.replace("+", "")}`);
