...
const TelegramLogin = () => {
  ...
  const checkIfPhoneExists = async () => {
    const res = await fetch(`https://script.google.com/macros/s/AKfycbzC5FCDTYMLbsVvgMk2i1EpTHjPSFNbZ6GqRkt_f9ywIH0PP4F6fcGq5myRqRiGpzEf/exec?phone=${phone.replace("+", "")}`);
