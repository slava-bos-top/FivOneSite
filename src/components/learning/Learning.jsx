...
const rawItems = [
  {
    text: 'Discord та Telegram',
    hoverText: "Курси проходять реальному часі у додатку Discord — найкращій платформі для відео-, текстової та голосової комунікації. Марафони - у Месенджері Telegram — захищеному та зручному додатку"
  },
  {
    text: '5-6 інтерактивів за заняття',
    hoverText: "Усі заняття містять інтерактивні завдання (чат-боти, квізи, опитування, командні проєкти), які допомагають засвоїти матеріал уроку"
  },
  {
  ...
  },
  {
    ...
    hoverText: "Заняття проходять у зручний для всієї групи час з можливістю передивитись запис заняття після завершення уроку"
  },
  {
