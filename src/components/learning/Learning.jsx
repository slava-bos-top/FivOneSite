...
const rawItems = [
  ...
  {
    text: 'Різні галузі знань',
    hoverText: "Починай з того, що тобі сподобалось найбільше, але пам`ятай, що зупинитись буде важко! Адже тут цікаво!"
  },
  {
  ...
  {
    text: 'Власна статистика',
    hoverText: "Ти зможеш в зручному форматі відслідковувати власний прогрес та розуміти, скільки уроків вже пройдено"
  },
  {
  ...
  {
    text: 'Структурована інформація',
    hoverText: "Інформація подається блоками для більш легкого засвоєння"
  }
];
